    ...
    <div style={{
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: 600, letterSpacing: "-0.02em", marginBottom: "8px" }}>Welcome back</h1>
          <p style={{ color: "#666", fontSize: "15px" }}>Log in to continue to your workspace.</p>
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "14px" }}>
            <label style={{ display: "flex", alignItems: "center", gap: "8px", cursor: "pointer", color: "#444" }}>
              <input 
                type="checkbox" 
            ...
            <Link href="#" style={{ color: "#111", fontWeight: 500, textDecoration: "none" }}>Forgot password?</Link>
          </div>
        ...
        <div style={{ textAlign: "center", marginTop: "32px", fontSize: "14px", color: "#666" }}>
          New here?{" "}
          <Link href="/signup" style={{ color: "#111", fontWeight: 600, textDecoration: "none" }}>Create an account</Link>
        </div>
      </motion.div>
    </div>
  );
