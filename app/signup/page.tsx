...
export default function SignupPage() {
  ...
  const strengthColor = strength < 2 ? "#ef8888" : strength < 4 ? "#f9a86b" : "#0e8f83";
    ...
    <AuthLayout>
      <div className="auth-card-light">
        <div className="auth-header-light">
          ...
          <p>Start your journey with FlexiAi</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="auth-form">
          ...
          <div className="auth-field">
            ...
            {/* Strength bar */}
            {password.length > 0 && (
              <div style={{ display: "flex", gap: "5px", marginTop: "8px", padding: "0 2px" }}>
                {[1, 2, 3, 4].map((level) => (
                  <div
                    key={level}
                    style={{
          ...
          <button
            ...
            disabled={loading}
            style={{ marginTop: password.length > 0 ? "4px" : "6px" }}
          >
            {loading ? (
        ...
        <div className="auth-social-row">
          <button id="signup-google" className="social-btn" aria-label="Continue with Google">
          ...
          <button id="signup-github" className="social-btn" aria-label="Continue with GitHub">
          ...
          <button id="signup-apple" className="social-btn" aria-label="Continue with Apple">
        ...
        <div className="auth-footer-text">
          ...
          <Link href="/login" style={{ fontWeight: 600, color: "#1a1816" }}>
            Sign in
          </Link>
        </div>
      </div>
